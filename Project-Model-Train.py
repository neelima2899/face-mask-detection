...
def PreProcess():
    for category in CATEGORIES:
        ...
        for imgs in tqdm(os.listdir(path)):
            ...
            x.append(resized_array)  # Append image data
            y.append(classIndex)   # Append class index (0 for no_mask, 1 for mask)
...
batch_size = 32  #The number of images the model will process in one iteration.
epochs = 15   #The number of times the model will go through the entire training dataset.
